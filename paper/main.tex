...
% Structured authorship lives in rrxiv-meta.json (RRP-0021 + RRP-0026).
% The parser merges that block onto these names by exact match. Keep
% the names here byte-identical to rrxiv-meta.json `authors[].name`
% so attribution doesn't drift across the build + parse boundary.
